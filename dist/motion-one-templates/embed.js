...
const MOTION_CDN = "https://cdn.jsdelivr.net/npm/motion@12.23.12/dist/motion.min.js";
/**
 ...
 */
export function buildMotionOneTemplates(resolved) {
 ...
 */
export function embedMotionOneInHtml(html, resolved) {
 ...
 */
export function motionOneCdnScriptTag() {
